...
function printHelp(){ 
        ...
        WScript.Echo(""); 
        WScript.Echo("Usage:"); 
        WScript.Echo("  " + scriptName + " \"title\" \"string\""); 
	...
	WScript.Echo("For special keys visit http://social.technet.microsoft.com/wiki/contents/articles/5169.vbscript-sendkeys-method.aspx");
} 
